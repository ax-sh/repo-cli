...
- Add new field [`4c09bb4`](https://github.com/ax-sh/ax-sh.github.io/commit/4c09bb42487e87f5eacb43dcabc035306a60fcfb)
- Add new react sub command [`ff763ca`](https://github.com/ax-sh/ax-sh.github.io/commit/ff763ca12e04a23b167599af664b81d0d1b07704)
- *(react)* Add project name parameter to makeReactProject [`c563b06`](https://github.com/ax-sh/ax-sh.github.io/commit/c563b063d463dbc362ca24439802b62ec30990e7)
- Add new sandbox sub command [`ea04a6c`](https://github.com/ax-sh/ax-sh.github.io/commit/ea04a6c340e7ec133347209c6936a4b92852665e)
- *(sandbox)* Add Python sandbox setup function and logging [`2686974`](https://github.com/ax-sh/ax-sh.github.io/commit/26869748582c6501c4ed25875913b8dd0290b184)
- *(go)* Add CLI command for Go project setup [`3a20781`](https://github.com/ax-sh/ax-sh.github.io/commit/3a207811576976438d557a4148410d9d4d74ca6b)
- *(go)* Add Go libraries and improve output formatting [`4c50dcc`](https://github.com/ax-sh/ax-sh.github.io/commit/4c50dcc79225c9eddf500ec638d5ff2ebf9550ba)
- *(go.service)* Add code quality tools installation commands [`a229bdf`](https://github.com/ax-sh/ax-sh.github.io/commit/a229bdfd643512b243ee6c8efe0827fb5b44dde4)
- *(go.service)* Add code quality tools installation commands [`4edd96c`](https://github.com/ax-sh/ax-sh.github.io/commit/4edd96c30cda66ba8ac4ab6016b6e0c716734ac2)
- *(go.service)* Add code quality tools installation commands [`8ecfced`](https://github.com/ax-sh/ax-sh.github.io/commit/8ecfcedce198628d726585fdbe8f75f7a3aeb833)
- *(eslint)* Add format and format:check scripts to eslint [`aab0f16`](https://github.com/ax-sh/ax-sh.github.io/commit/aab0f1632f44e984e0f20719225961c134fedcc5)
- Export mac blender path [`60973cc`](https://github.com/ax-sh/ax-sh.github.io/commit/60973cc578bb39bbff3e8360cc1c4a8897c3b9ee)
- *(lint)* Add lint-fast command and related tests [`614ca74`](https://github.com/ax-sh/ax-sh.github.io/commit/614ca743f8341ca89f6515bc42c58978f7057832)
- *(commands)* Move lint-fast command and add script configurations [`e0e8d1b`](https://github.com/ax-sh/ax-sh.github.io/commit/e0e8d1bbe0042f2532b29508d89801f4331a6e0d)

### 🐛 Bug Fixes

- *(eslint)* Update eslint command in addEslint function [`642e44e`](https://github.com/ax-sh/ax-sh.github.io/commit/642e44ea2f3fa1a9a9e6a07295b3a257526cdd77)
- Type and error handling [`6ade407`](https://github.com/ax-sh/ax-sh.github.io/commit/6ade407a54164bb5c4a7272788e533219c573ef6)

### 🚜 Refactor

- *(pkgroll)* Simplify package installation command [`393ecf8`](https://github.com/ax-sh/ax-sh.github.io/commit/393ecf8ff77e4955fe1399c45298c29291e97e8d)
- *(sandbox.service)* Clean up imports and comments [`ff3c79a`](https://github.com/ax-sh/ax-sh.github.io/commit/ff3c79a30fd2c63fdb0cecc3db23d62e0728ede0)
- *(commands/sandbox)* Update spinner messages for clarity [`fb362b6`](https://github.com/ax-sh/ax-sh.github.io/commit/fb362b6984de50a415b35592a824013bdad28f7e)
- Remove unused variables and improve error handling [`e61400a`](https://github.com/ax-sh/ax-sh.github.io/commit/e61400a8097c49df58586edf1607dce4a882edb8)
- *(sandbox)* Simplify makePythonSandbox implementation [`1c577a6`](https://github.com/ax-sh/ax-sh.github.io/commit/1c577a66c7e6507e9f7459162b7537767bfbdb2b)
- *(sandbox.service)* Update pytest dependency in command [`790039d`](https://github.com/ax-sh/ax-sh.github.io/commit/790039db1d8a708f46e2c2a8a2c151a3e62ebde4)
- Types [`f7591e7`](https://github.com/ax-sh/ax-sh.github.io/commit/f7591e717e1621291d51eb8c6575ec235a24a1b1)
- *(blendToGlb)* Remove hardcoded blender path [`5aa7154`](https://github.com/ax-sh/ax-sh.github.io/commit/5aa7154692bc390b8bf1ee55dc815093f60ec2f8)
- *(npm-list)* Make owner optional in GithubNpmPackages [`804aefc`](https://github.com/ax-sh/ax-sh.github.io/commit/804aefca6b06e7ffc9ef38673f61eba9006bac9b)

### 📚 Documentation

- *(sandbox.service)* Update integration documentation links [`c0d9ec4`](https://github.com/ax-sh/ax-sh.github.io/commit/c0d9ec43a0ddd8af72775257a61839945033db1f)
- *(sandbox.service)* Add pytest-watch documentation link [`4eda850`](https://github.com/ax-sh/ax-sh.github.io/commit/4eda85046fde9a305941546721f47512ca7e9659)

### 🎨 Styling

- Standardize arrow function syntax in codebase [`1def3c8`](https://github.com/ax-sh/ax-sh.github.io/commit/1def3c8e39526e7071104eeb76644d841c3f810b)
- Fix quotes in eslint configuration files [`aceb20d`](https://github.com/ax-sh/ax-sh.github.io/commit/aceb20dc1b93847c699f91dfe878825678cedceb)
- Format imports for consistency and readability [`0c21b61`](https://github.com/ax-sh/ax-sh.github.io/commit/0c21b61d0fa7d9db23120c544b5438ae4b6ba133)
- Standardize quotes in configuration files [`94373f5`](https://github.com/ax-sh/ax-sh.github.io/commit/94373f52586696a97a3f4bf30f6b30a5132acb1c)
- *(test)* Update comments in sandbox service test file [`78ab019`](https://github.com/ax-sh/ax-sh.github.io/commit/78ab019ff75253150aec5d9186e7c6b0235c93e1)
- Update console warning format and test description [`f536693`](https://github.com/ax-sh/ax-sh.github.io/commit/f536693019d6c0cfbebd07c1f1f75c50b16120a0)

### 🧪 Testing

- *(sandbox)* Update python version in test command output [`7c7509e`](https://github.com/ax-sh/ax-sh.github.io/commit/7c7509e7350df9c71fc7993aeb26342ba0193554)
- Update test expectations and command output validation [`d6314b8`](https://github.com/ax-sh/ax-sh.github.io/commit/d6314b8730b6444a9dd0cbba50263b2f0d16597e)
- *(blendToGlb)* Update test to use it.todo syntax [`01c4faa`](https://github.com/ax-sh/ax-sh.github.io/commit/01c4faad7120771eabaf69764850262252ab35b8)

### ⚙️ Miscellaneous Tasks

- *(pkgroll)* Add commented npm package setup instructions [`92321b4`](https://github.com/ax-sh/ax-sh.github.io/commit/92321b46b36a691acdedc2bc92635b9da992204c)
- Add comment with GitHub link in pkgroll.service.ts [`21843ae`](https://github.com/ax-sh/ax-sh.github.io/commit/21843ae13cc5a8b1c74c1d65f7e5856f1b789026)
- Rename pkgroll command file to add directory [`4eb28c0`](https://github.com/ax-sh/ax-sh.github.io/commit/4eb28c0c45430af8a531987d8f8d74dea1a80054)
- Update package versions in package.json [`5d47397`](https://github.com/ax-sh/ax-sh.github.io/commit/5d4739736e5b350a69fd3ad049939a3c3c7f83fc)
- Update package versions in package.json [`6e48346`](https://github.com/ax-sh/ax-sh.github.io/commit/6e48346e365024f74ebd9ac7b666770fd80e106d)
- Update schema [`6342459`](https://github.com/ax-sh/ax-sh.github.io/commit/6342459f015cadd606b08a1b22d17bd1b69d2b9b)
- Update dependencies in package.json [`cc9bfd8`](https://github.com/ax-sh/ax-sh.github.io/commit/cc9bfd8185501d9c783c656c1462a6fe06ad01a7)
...
- Add CHANGELOG [`8bfea7a`](https://github.com/ax-sh/ax-sh.github.io/commit/8bfea7a284c4b5d806023116917dc0f85f338a26)
